...
- **创作者工作台 UI**：首页升级为本地优先的创作者控制台，统一展示账号状态、笔记规模和当前模块
...
- 顶部显示当前账号、笔记规模和当前模块
- 主导航切换笔记管理、画像、选题、分析、创作、对话和设置
- 统一使用卡片式信息架构、暖色编辑感配色和更明确的状态反馈
...
- 文本模型使用 OpenAI 兼容接口：在设置页填写对应服务商的 API Key、Base URL 和模型名即可
- 图片识别优先支持 OpenAI 兼容视觉接口：在设置页填写对应服务商的 API Key、Base URL 和模型名即可
